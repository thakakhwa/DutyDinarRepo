 ...
 * 
 * This API endpoint generates Apple Wallet passes for events
 */
error_reporting(E_ALL);
ini_set('display_errors', 0);
ini_set('log_errors', 1);
ini_set('error_log', __DIR__ . '/apple_pass_api.log');
...
// Include the ApplePassGenerator class
require_once 'apple_pass_generator.php';
...
try {
    ...
    // Now generate the Apple Wallet pass
    $passGenerator = new ApplePassGenerator();
    ...
    error_log("Error in generate_apple_pass.php: " . $e->getMessage());
    http_response_code(500);
